...
nealia_file = os.path.join(
    path, 'Qualitative Sub Study Subject List 28JUL2016.csv')
...
export_file = os.path.join(
    path, 'Qualitative Sub Study Subject List 28JUL2016-with_pims.csv')
...
# merged dataframes
df = pd.merge(df_nealia, df_subjects, how='left',
...
date_columns = ['T1_visit_date', 'consent_date', 'dob',
                'consent_datetime', 'pims_registration_date', 'interview_date']
