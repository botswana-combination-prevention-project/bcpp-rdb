...
(''Q10A''::text),
(''Q16''::text),
(''INTERVIEW_DATE'')'::text) x(dimstudyparticipantkey integer, prior_hiv_test_result text, self_report_hiv_test_result text, hiv_test_result text, citizen_ind text, community_name text, has_omang text, omang_nbr text, gender text, perm_resident text, parttime_resident text, testing_site text, interview_date text)
